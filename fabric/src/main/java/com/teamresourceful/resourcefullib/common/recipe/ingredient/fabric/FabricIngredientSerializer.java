...
public class FabricIngredientSerializer<T extends CodecIngredient<T>> implements CustomIngredientSerializer<@NotNull FabricIngredient<T>> {
    ...
    private final StreamCodec<@NotNull RegistryFriendlyByteBuf, @NotNull FabricIngredient<T>> packetCodec;
    ...
    @Override
    public @NotNull StreamCodec<@NotNull RegistryFriendlyByteBuf, @NotNull FabricIngredient<T>> getPacketCodec() {
