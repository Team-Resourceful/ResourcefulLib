...
dependencies {
    ...
    implementation fg.deobf("com.teamresourceful.resourcefullib:resourcefullib-forge-1.20-pre6:2.0.2")
}
```
...
dependencies {
    <--- Other dependencies here --->
    implementation "com.teamresourceful.resourcefullib:resourcefullib-fabric-1.20-pre6:2.0.2"
}
```
...
dependencies {
    <--- Other dependencies here --->
    modImplementation "com.teamresourceful.resourcefullib:resourcefullib-common-1.20-pre6:2.0.2"
}
```
...
dependencies {
    <--- Other dependencies here --->
    modImplementation "com.teamresourceful.resourcefullib:resourcefullib-fabric-1.20-pre6:2.0.2"
}
```
...
dependencies {
    <--- Other dependencies here --->
    modImplementation "com.teamresourceful.resourcefullib:resourcefullib-forge-1.20-pre6:2.0.2"
}
```
