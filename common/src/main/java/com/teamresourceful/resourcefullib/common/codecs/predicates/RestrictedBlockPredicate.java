...
public record RestrictedBlockPredicate(@NotNull Block block, @NotNull NbtPredicate nbt, @NotNull LocationPredicate location, @NotNull BlockStatePredicate properties) {
